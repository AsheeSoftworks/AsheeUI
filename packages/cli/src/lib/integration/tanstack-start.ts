/**
 * TanStack Start integration builder for AsheeUI CLI.
 * This module provides the buildTanStackStartIntegration function that
 * generates all file writes, edits, and integrity checks required to
 * wire AsheeUI into a TanStack Start project.
 */
